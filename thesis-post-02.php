    ...
    <div class="main-wrapper" 
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
			<div class="border border-top-0 border-left-0 border-right-0 pl-3 mb-1">
				<h4>How Expressive Arts Theraphy and Outdoor Adventure Activities Can Increase Interpersonal Communication Skills: Adventure in Building Communication with Children</h4>
			</div><!--Post Title-->
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    ...
					    <div class="media-body">
							<div class="mb-1"><span class="tags"><strong>Tags: </strong></span><span class="tag-word"><a href="#">child</a>, <a href="#">theraphy</a>, <a href="#">arts</a></span></div>
							<div class="mb-1"><span class="Author"><strong>Author(s): </strong></span><span class="Author"><a>Anita R. Tucker</a></span></div>
							<div class="mb-1"><span class="date"><strong>Published:</strong> January 11, 2020. 12:51 A.M. by admin</span></div>
			...
			<div class="pl-3 mb-4">
				<h5>Abstract:</h5>
				<div class="intro">This article presents adventure-based group therapy as one type
of activity-based group treatment that can be used to promote
social skills in adolescents. Adventure-based therapy groups are
...
use of novel and unfamiliar environments, and the use of
physical trust. The article includes practice examples of how
these factors can be used to promote social skills and discusses
limitations and implications for social work group practice.
				</div>
			</div><!--Abstract-->
			...
			<div class="pl-3 mb-1">
				...
				<div class="ml-5">
					<a class="tag-word" title="An Exploration of the Interrelationships between Self, Art and Oppression" href="thesis-post-03.php">
									•An Exploration of the Interrelationships between Self, Art and Oppression</a>
					<br>
					<a class="tag-word" title="How Music Affects Early Childhood Development" href="thesis-post-01.php">
									•How Music Affects Early Childhood Development</a>
				</div>
...
<?php
 ...
 if($_POST['Submit']){
  ...
  #Get old comments
  $old = fopen("assets\db-msg\comments-02.txt", "r+t");
  $old_comments = fread($old, 1024);

  #Delete everything, write down new and old comments
  $write = fopen("assets\db-msg\comments-02.txt", "w+");
 ...
 #Read comments
 $read = fopen("assets\db-msg\comments-02.txt", "r+t");
