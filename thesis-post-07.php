    ...
    <div class="main-wrapper" 
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
			<div class="border border-top-0 border-left-0 border-right-0 pl-3 mb-1">
				<h4>Cloud Based Monitoring System for Events and Marketing</h4>
			</div><!--Post Title-->
		    <div class="container-fluid">
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex border border-light" src="assets/images/blog/Cloud-Based-Monitoring-System-for-Events-and-Marketing.jpg" alt="image">
					    <div class="media-body">
							<div class="mb-1"><span class="tags"><strong>Tags: </strong></span><span class="tag-word"><a href="#">cloud</a>, <a href="#">development</a>, <a href="#">application</a></span></div>
							<div class="mb-1"><span class="Author"><strong>Author(s): </strong></span><span class="Author"><a>Trus Radius Website</a></span></div>
							<div class="mb-1"><span class="date"><strong>Published:</strong> January 6, 2020. 12:51 A.M. by admin</span></div>
			...
			<div class="pl-3 mb-4">
				<h5>Abstract:</h5>
				<div class="intro">Event Monitoring Software is a subset of network monitoring
...
<?php
 ...
 if($_POST['Submit']){
  ...
  #Get old comments
  $old = fopen("assets\db-msg\comments-07.txt", "r+t");
  $old_comments = fread($old, 1024);

  #Delete everything, write down new and old comments
  $write = fopen("assets\db-msg\comments-07.txt", "w+");
 ...
 #Read comments
 $read = fopen("assets\db-msg\comments-07.txt", "r+t");
