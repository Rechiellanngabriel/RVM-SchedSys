    ...
    <div class="main-wrapper" 
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
			<div class="border border-top-0 border-left-0 border-right-0 pl-3 mb-1">
				<h4>Arduino Based Insect Tracker</h4>
			</div><!--Post Title-->
		    <div class="container-fluid">
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex border border-light" src="assets/images/blog/arduino-insect-tracker.jpg" alt="image">
					    <div class="media-body">
							<div class="mb-1"><span class="tags"><strong>Tags: </strong></span><span class="tag-word"><a href="#">arduino</a>, <a href="#">development</a>, <a href="#">application</a></span></div>
							<div class="mb-1"><span class="Author"><strong>Author(s): </strong></span><span class="Author"><a>Mitomon</a></span></div>
							<div class="mb-1"><span class="date"><strong>Published:</strong> January 8, 2020. 12:51 A.M. by admin</span></div>
			...
			<div class="pl-3 mb-4">
				<h5>Abstract:</h5>
				<div class="intro">I decided to build this to both solve a problem and learn
about Helium. In the hot summer, mosquitos like to fly
around and bite everyone, especially in the afternoon. This
means I have to choose between going outside in the 100
degree temperatures of high noon, or not sweat as much but
get attacked by swarms of the flying insects. The main killing
			...
			<div class="pl-3 mb-1">
				...
				<div class="ml-5">
					<a class="tag-word" title="iHELP: information about Health Advisory of COVID-19, Emergency Hotlines, Learning First-Aid, and Preparedness in Disaster" href="thesis-post-04.php">
									•The iHELP mobile application</a>
					<br>
					<a class="tag-word" title="Arduino Self Timer for the Cloud" href="thesis-post-06.php">
									•Arduino Self Timer for the Cloud</a>
					<br>
...
<?php
 ...
 if($_POST['Submit']){
  ...
  #Get old comments
  $old = fopen("assets\db-msg\comments-05.txt", "r+t");
  $old_comments = fread($old, 1024);

  #Delete everything, write down new and old comments
  $write = fopen("assets\db-msg\comments-05.txt", "w+");
 ...
 #Read comments
 $read = fopen("assets\db-msg\comments-05.txt", "r+t");
