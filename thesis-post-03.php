    ...
    <div class="main-wrapper" 
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
			<div class="border border-top-0 border-left-0 border-right-0 pl-3 mb-1">
				<h4>An Exploration of the Interrelationships between Self, Art and Oppression</h4>
			</div><!--Post Title-->
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    ...
					    <div class="media-body">
							<div class="mb-1"><span class="tags"><strong>Tags: </strong></span><span class="tag-word"><a href="#">theraphy</a>, <a href="#">development</a>, <a href="#">arts</a></span></div>
							<div class="mb-1"><span class="Author"><strong>Author(s): </strong></span><span class="Author"><a>Kimberly Bender</a></span></div>
							<div class="mb-1"><span class="date"><strong>Published:</strong> January 10, 2020. 12:51 A.M. by admin</span></div>
...
<?php
 ...
 if($_POST['Submit']){
  ...
  #Get old comments
  $old = fopen("assets\db-msg\comments-03.txt", "r+t");
  $old_comments = fread($old, 1024);

  #Delete everything, write down new and old comments
  $write = fopen("assets\db-msg\comments-03.txt", "w+");
 ...
 #Read comments
 $read = fopen("assets\db-msg\comments-03.txt", "r+t");
